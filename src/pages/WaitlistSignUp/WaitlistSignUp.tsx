      ...
      <div className="WaitlistSignUp">
        <div className="WaitlistSignUp__content">
          ...
          <p className="WaitlistSignUp__subtitle">
            We're currently in closed beta as we onboard partners and add more
            features. Sign up for the waitlist.
          </p>
          ...
          {success && <div className="WaitlistSignUp__success">{success}</div>}

          <Button
            textWeight="heavy"
            className="WaitlistSignUp__button"
            onClick={handleFormSubmit}
          >
            {registerInProgress ? "Signing up ..." : "Sign up for the waitlist"}
          </Button>

          <img
            className="WaitlistSignUp__img"
            src={rocketTicket}
            alt="rocketTicket"
          />
        </div>
