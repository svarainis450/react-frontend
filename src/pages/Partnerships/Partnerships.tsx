  ...
  return (
    <Layout>
      <div className="Partnerships">
        ...
        >
          <div className="Partnerships__title">Potato Partnership Program</div>

          <div className="Partnerships__subtitle">
            Join Potato Partnerships Program and start earning commission now!
            You can earn at least 5$ commission for each sale you deliver!
          </div>
        </HeroMiniBlock>
        ...
        <div className="Partnerships__teasers">
          <TwoSideSimple className="Partnerships__TwoSideSimple">
            <TwoSideSimple.Left>
              ...
              <div className="Partnerships__TwoSideSimple__text">
                You can earn at least 5$ commission for each sale you deliver.
                The more revenue you make - the higher the commission you get!
              </div>
            </TwoSideSimple.Left>
            ...
            <TwoSideSimple.Right>
              ...
              <div className="Partnerships__TwoSideSimple__text">
                Potato conversion rates are one of the highest in the industry.
                Thus, you can be assured that your traffic will convert in all
                GEOs! We will provide you with localized landing pages and a
                huge selection of creatives and other assets to reach the
                maximum results.
              </div>
            </TwoSideSimple.Right>
          </TwoSideSimple>
          ...
          <TwoSideSimple className="Partnerships__TwoSideSimple">
            <TwoSideSimple.Left>
              ...
              <div className="Partnerships__TwoSideSimple__text">
                If you are only starting now, don't worry - we got you! We will
                assign you a dedicated account manager who will assist you in
                setting up and launching campaigns. Our managers are here to
                make sure that all your campaigns are successful.
              </div>
            </TwoSideSimple.Left>
            ...
            <TwoSideSimple.Right>
              ...
              <div className="Partnerships__TwoSideSimple__text">
                Currently over 50k users worldwide trust ColonBroom. We cover
                the United States, Australian, Canadian and New Zealand markets
                and have a team of over 50 marketing professionals that make
                every campaign a success! The numbers are rapidly growing!
              </div>
            </TwoSideSimple.Right>
          </TwoSideSimple>
        </div>
        ...
        <div className="Partnerships__videos">
          <TwoSideSimple className="Partnerships__TwoSideSimple">
            <TwoSideSimple.Left>
              ...
              <div className="Partnerships__TwoSideSimple__text">
                Influencers of any platform (Youtube, Instagram, Podcast, Tik
                Tok) and any size who have a strong desire to work with health
                and nutrition brands. Affiliates that have blogs, news sites,
                review or coupons sites, etc. If you are interested in covering
                crypto, NFT, web3 topics (and earning a high commission) - you
        ...
        <div className="Partnerships__videos">
          <TwoSideSimple className="Partnerships__TwoSideSimple" rtl={true}>
            ...
            <TwoSideSimple.Right>
              ...
              <div className="Partnerships__TwoSideSimple__text">
                Sign up for the Potato Partnership Program and start promoting
                our product on your website or social media channels.
                <br />
                <br />
                You will receive commission for every visitor who purchases
                Potato via your links. This is a great way to earn at least 5$
                commission per purchase and help others learn why using Potato
                is so great.
              </div>
            </TwoSideSimple.Right>
          </TwoSideSimple>
