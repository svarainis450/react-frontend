...
export const FAQ = ({ faqItems, noTitle, className, noCta }: FAQprops) => {
  return (
    <div className={classNames('FAQ', className)}>
      {!noTitle && (
        <>
          <HeroTitle className="FAQ__hero" title="Frequently asked questions" />
        </>
      )}
      ...
      <div className="FAQ__wrapper">
          ...
          return (
            ...
            >
              ...
              <AccordionDetails className="FAQ__accordeon-item__text-wrapper">
                <Typography
                  className="FAQ__accordeon-item__text"
        ...
        {!noCta && (
          <Link to="/faq">
            <Button className="FAQ__button">Read more FAQ</Button>
          </Link>
        )}
      </div>
    </div>
