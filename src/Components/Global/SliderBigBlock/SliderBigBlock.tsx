...
export const SliderBigBlock = () => {
  ...
  return (
    <div className="SliderBigBlock">
          ...
          <div className="SliderBigBlock__wrapper">
            <div className="SliderBigBlock__content">
              ...
              <div className="SliderBigBlock__infograph">
                <img
                  className="SliderBigBlock__infograph__img SliderBigBlock__infograph__img--circle"
                  src={infograph1}
                  alt="heroMessage"
                />
              </div>
            ...
            <div className="SliderBigBlock__img">
              <img
                className="SliderBigBlock__message"
                src={ss2}
                alt="heroMessage"
              />
            </div>
        ...
        <SwiperSlide>
          <div className="SliderBigBlock__wrapper">
            <div className="SliderBigBlock__content">
              ...
              <div className="SliderBigBlock__infograph">
                <img
                  className="SliderBigBlock__infograph__img SliderBigBlock__infograph__img--slider"
                  src={infograph2}
                  alt="heroMessage"
                />
              </div>
      ...
      <Button
        onClick={() => navigate(LinkList.Pricing)}
